...
@click.option('--executor', type=click.Choice(['mock', 'beamng', 'dave2', 'commonroad'], case_sensitive=False), default="mock",
              show_default='Mock Executor (meant for debugging)',
              help="The name of the executor to use. Currently we have 'mock', 'beamng', 'dave2' or 'commonroad'.")
